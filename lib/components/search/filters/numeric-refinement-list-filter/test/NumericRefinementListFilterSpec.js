...
describe('NumericRefinementListFilter tests', function () {
    beforeEach(function () {
        ...
        _this.getOptionAt = function (index) { return _this.wrapper.find('.sk-item-list-option').at(index); };
    });
    ...
    it('should deselect already selected option for single select', function () {
        _this.setWrapper();
        _this.setResults();
        _this.wrapper = _this.wrapper.update();
        var secondOption = _this.getOptionAt(1);
    ...
    it('should be disabled for empty buckets', function () {
        _this.setWrapper();
        expect(_this.wrapper.find('.sk-panel.is-disabled')).toHaveLength(1);
    });
